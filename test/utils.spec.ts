...
describe("Utils", () => {
  it("hexToBytes - zero", () => {
    console.log('empty', utils.hexToBytes("000000"))
    expect(Array.from(utils.hexToBytes("000000"))).toEqual([0, 0, 0]);
  });

  it("hexToBytes - DEADBEEF", () => {
    expect(Array.from(utils.hexToBytes("DEADBEEF"))).toEqual([222, 173, 190, 239]);
  });
